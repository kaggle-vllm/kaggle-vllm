...
Status: **IN_PROGRESS; 41 / 60 PRINCIPAL SHARDS PRESERVED**.
...
`M4_SHARD_ID=llama32_3b-short-r03` and its expected evidence ZIP is
`llama32_3b-short-r03-principal.zip`. Qwen short and balanced r03 are preserved,
