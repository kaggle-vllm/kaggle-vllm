...
Status: **IN_PROGRESS; 38 / 60 PRINCIPAL SHARDS PRESERVED**.
...
`M4_SHARD_ID=phi4_mini-short-r03` and its expected evidence ZIP is
`phi4_mini-short-r03-principal.zip`. Qwen short and balanced r03 are preserved,
while Qwen prefill-heavy r03 is a fourth reviewed terminal resource result at
TP2/concurrency 64. Download the executed
...
model-scoped `M4_BATCH_ID=r03-phi` after its new source freeze; follow
