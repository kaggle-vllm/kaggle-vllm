...
| M4 principal breadth | FAIL | 44/60 four-model principal shards are canonical; four reviewed resource boundaries are settled and 12 shards remain not executed |
| M4 logical repetitions | FAIL | Phi, Ministral, Llama, and Qwen short/balanced have 4/5 canonical repetitions; Qwen prefill-heavy has 4/5 terminal resource results; no condition has five terminal repetitions |
