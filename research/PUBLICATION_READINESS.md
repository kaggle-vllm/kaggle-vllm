...
| M4 principal breadth | FAIL | 28/60 four-model principal shards are canonical; three reviewed resource boundaries are settled and 29 shards remain not executed |
| M4 logical repetitions | FAIL | Llama and Ministral have 3/5 canonical repetitions; Qwen short/balanced and all Phi workloads have 2/5; Qwen prefill-heavy has 3/5 terminal resource results; no condition has five terminal repetitions |
