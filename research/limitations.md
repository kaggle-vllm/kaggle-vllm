...
- M3 is a single fresh Kaggle dual-T4 session with five fresh-process
  ...
  principal matrix is in progress, with 12 of 60 logical shards preserved.
  ...
  preserved by the completed Phi, Llama, and Ministral continuations; 47 matrix shards are
