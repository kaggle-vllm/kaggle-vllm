...
- `M4_BATCH_SOURCE_FREEZE_V13.json`: post-Phi-r02 no-rerun freeze for the next Ministral r03 batch.
...
and all Phi r02 workloads are canonical from V12. The remaining principal matrix and M5 independent
