...
continuation is `fill-r00-phi`, containing exactly
`phi4_mini-short-r00`, `phi4_mini-balanced-r00`, and
`phi4_mini-prefill_heavy-r00` (36 fresh-server cells).
...
Run `M4_BATCH_ID=fill-r00-phi` in a fresh T4 x2 allocation. Do not rerun the
