...
|---:|---|---:|---|---:|---:|---|
| 1 | `r03-llama` | 3 | `llama32_3b` | 3 | 36 | — |
| 2 | `r04-qwen` | 4 | `qwen25_3b` | 3 | 36 | — |
| 3 | `r04-phi` | 4 | `phi4_mini` | 3 | 36 | — |
| 4 | `r04-llama` | 4 | `llama32_3b` | 3 | 36 | — |
| 5 | `r04-ministral` | 4 | `ministral3_3b_bf16` | 3 | 36 | — |

Next: `M4_BATCH_ID=r03-llama`.
