...
|---:|---|---:|---|---:|---:|---|
| 1 | `fill-r00-ministral` | 0 | `ministral3_3b_bf16` | 3 | 36 | — |
| 2 | `fill-r01-phi` | 1 | `phi4_mini` | 3 | 36 | — |
| 3 | `fill-r01-llama` | 1 | `llama32_3b` | 3 | 36 | — |
| 4 | `fill-r01-ministral` | 1 | `ministral3_3b_bf16` | 3 | 36 | — |
| 5 | `fill-r01-qwen` | 1 | `qwen25_3b` | 2 | 24 | `qwen25_3b-short-r01` |
| 6 | `r02-llama` | 2 | `llama32_3b` | 3 | 36 | — |
| 7 | `r02-ministral` | 2 | `ministral3_3b_bf16` | 3 | 36 | — |
| 8 | `r02-qwen` | 2 | `qwen25_3b` | 3 | 36 | — |
| 9 | `r02-phi` | 2 | `phi4_mini` | 3 | 36 | — |
| 10 | `r03-ministral` | 3 | `ministral3_3b_bf16` | 3 | 36 | — |
| 11 | `r03-qwen` | 3 | `qwen25_3b` | 3 | 36 | — |
| 12 | `r03-phi` | 3 | `phi4_mini` | 3 | 36 | — |
| 13 | `r03-llama` | 3 | `llama32_3b` | 3 | 36 | — |
| 14 | `r04-qwen` | 4 | `qwen25_3b` | 3 | 36 | — |
| 15 | `r04-phi` | 4 | `phi4_mini` | 3 | 36 | — |
| 16 | `r04-llama` | 4 | `llama32_3b` | 3 | 36 | — |
| 17 | `r04-ministral` | 4 | `ministral3_3b_bf16` | 3 | 36 | — |

Next: `M4_BATCH_ID=fill-r00-ministral`.
