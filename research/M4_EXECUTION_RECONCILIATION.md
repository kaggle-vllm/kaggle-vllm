...
- Canonical preserved: 22
- Failed resource gate: 2
...
|---:|---|---:|---|---:|---:|---|
| 1 | `r02-llama` | 2 | `llama32_3b` | 3 | 36 | — |
| 2 | `r02-ministral` | 2 | `ministral3_3b_bf16` | 3 | 36 | — |
| 3 | `r02-qwen` | 2 | `qwen25_3b` | 3 | 36 | — |
| 4 | `r02-phi` | 2 | `phi4_mini` | 3 | 36 | — |
| 5 | `r03-ministral` | 3 | `ministral3_3b_bf16` | 3 | 36 | — |
| 6 | `r03-qwen` | 3 | `qwen25_3b` | 3 | 36 | — |
| 7 | `r03-phi` | 3 | `phi4_mini` | 3 | 36 | — |
| 8 | `r03-llama` | 3 | `llama32_3b` | 3 | 36 | — |
| 9 | `r04-qwen` | 4 | `qwen25_3b` | 3 | 36 | — |
| 10 | `r04-phi` | 4 | `phi4_mini` | 3 | 36 | — |
| 11 | `r04-llama` | 4 | `llama32_3b` | 3 | 36 | — |
| 12 | `r04-ministral` | 4 | `ministral3_3b_bf16` | 3 | 36 | — |

Next: `M4_BATCH_ID=r02-llama`.
