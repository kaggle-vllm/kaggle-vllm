...
- M4 is complete: compatibility is closed and all 60 four-model principal
  logical outcomes are settled under the tracked no-rerun ledger. GitHub PR
  #24 is governance-only and is not research M4.
