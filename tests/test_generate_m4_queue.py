...
def test_queue_preserves_negative_compatibility_and_historical_shards() -> None:
    ...
    assert by_id["qwen25_3b-balanced-r01"]["status"] == "PRINCIPAL_SHARD_PRESERVED"
    assert by_id["qwen25_3b-prefill_heavy-r01"]["status"] == "FAILED_RESOURCE_GATE"
    assert by_id["qwen25_3b-prefill_heavy-r02"]["status"] == "FAILED_RESOURCE_GATE"
    assert by_id["qwen25_3b-short-r02"]["status"] == "PRINCIPAL_SHARD_PRESERVED"
    assert by_id["qwen25_3b-balanced-r02"]["status"] == "PRINCIPAL_SHARD_PRESERVED"
    assert by_id["qwen25_3b-short-r03"]["status"] == "PRINCIPAL_SHARD_PRESERVED"
    assert by_id["qwen25_3b-balanced-r03"]["status"] == "PRINCIPAL_SHARD_PRESERVED"
    assert by_id["qwen25_3b-prefill_heavy-r03"]["status"] == "FAILED_RESOURCE_GATE"
    assert by_id["qwen25_3b-balanced-r04"]["status"] == "PRINCIPAL_SHARD_PRESERVED"
    assert by_id["qwen25_3b-prefill_heavy-r04"]["status"] == "FAILED_RESOURCE_GATE"
    assert by_id["qwen25_3b-short-r04"]["status"] == "PRINCIPAL_SHARD_PRESERVED"
    ...
    assert (
        by_id["llama32_3b-prefill_heavy-r03"]["status"]
        == "PRINCIPAL_SHARD_PRESERVED"
    )
    assert by_id["llama32_3b-balanced-r04"]["status"] == "PRINCIPAL_SHARD_PRESERVED"
    assert by_id["llama32_3b-prefill_heavy-r04"]["status"] == "PRINCIPAL_SHARD_PRESERVED"
    assert by_id["llama32_3b-short-r04"]["status"] == "PRINCIPAL_SHARD_PRESERVED"
    assert by_id["phi4_mini-prefill_heavy-r02"]["status"] == "PRINCIPAL_SHARD_PRESERVED"
    assert by_id["phi4_mini-short-r02"]["status"] == "PRINCIPAL_SHARD_PRESERVED"
    assert by_id["phi4_mini-balanced-r02"]["status"] == "PRINCIPAL_SHARD_PRESERVED"
    assert by_id["llama32_3b-prefill_heavy-r02"]["status"] == "PRINCIPAL_SHARD_PRESERVED"
    assert by_id["llama32_3b-short-r02"]["status"] == "PRINCIPAL_SHARD_PRESERVED"
    assert by_id["llama32_3b-balanced-r02"]["status"] == "PRINCIPAL_SHARD_PRESERVED"
    assert by_id["ministral3_3b_bf16-prefill_heavy-r02"]["status"] == "PRINCIPAL_SHARD_PRESERVED"
    assert by_id["ministral3_3b_bf16-short-r02"]["status"] == "PRINCIPAL_SHARD_PRESERVED"
    assert by_id["ministral3_3b_bf16-balanced-r02"]["status"] == "PRINCIPAL_SHARD_PRESERVED"
    ...
    assert by_id["ministral3_3b_bf16-short-r00"]["status"] == "PRINCIPAL_SHARD_PRESERVED"
    assert by_id["ministral3_3b_bf16-balanced-r00"]["status"] == "PRINCIPAL_SHARD_PRESERVED"
    assert by_id["ministral3_3b_bf16-prefill_heavy-r00"]["status"] == "PRINCIPAL_SHARD_PRESERVED"
    assert by_id["phi4_mini-balanced-r01"]["status"] == "PRINCIPAL_SHARD_PRESERVED"
    assert by_id["phi4_mini-prefill_heavy-r01"]["status"] == "PRINCIPAL_SHARD_PRESERVED"
    assert by_id["phi4_mini-short-r01"]["status"] == "PRINCIPAL_SHARD_PRESERVED"
    assert by_id["llama32_3b-balanced-r01"]["status"] == "PRINCIPAL_SHARD_PRESERVED"
    assert by_id["llama32_3b-prefill_heavy-r01"]["status"] == "PRINCIPAL_SHARD_PRESERVED"
    assert by_id["llama32_3b-short-r01"]["status"] == "PRINCIPAL_SHARD_PRESERVED"
    assert by_id["ministral3_3b_bf16-balanced-r01"]["status"] == "PRINCIPAL_SHARD_PRESERVED"
    assert by_id["ministral3_3b_bf16-prefill_heavy-r01"]["status"] == "PRINCIPAL_SHARD_PRESERVED"
    assert by_id["ministral3_3b_bf16-short-r01"]["status"] == "PRINCIPAL_SHARD_PRESERVED"
